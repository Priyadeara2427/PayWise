...
from ..models.obligation import Obligation, FinancialState, Decision

logger = logging.getLogger(__name__)

class IngestionPipeline:
    """Main ingestion pipeline for processing various input formats with intelligent classification"""
    ...
    async def _store_in_mongodb(self, financial_state: FinancialState, 
        ...
        """Store processed data in MongoDB with enhanced metadata"""
    ...
    async def process_batch(self, file_paths: List[str], generate_decisions: bool = True) -> List[Dict[str, Any]]:
